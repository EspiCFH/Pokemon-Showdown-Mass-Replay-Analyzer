...
###### second note: as of the most recent version (1.6), this program will likely not work for VGC. this is due to the program's heavy use of deductive reasoning with the nature of single battles.
